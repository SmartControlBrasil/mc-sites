									...
									for (
										...
										(!o.vertices[a - 1].isInternal || c
											...
											o.vertices[a].isInternal &&
												!c &&
												l.moveTo(
													o.vertices[(a + 1) % o.vertices.length]
														.x,
													o.vertices[(a + 1) % o.vertices.length]
														.y,
												));
								...
								for (o = 0; o < l.vertices.length; o++)
									((a.fillStyle = "rgba(255,255,255,0.2)"),
										a.fillText(
											i + "_" + o,
											l.position.x +
												0.8 * (l.vertices[o].x - l.position.x),
											l.position.y +
												0.8 * (l.vertices[o].y - l.position.y),
										));
							}
						}
					}),
